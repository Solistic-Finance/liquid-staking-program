...
import { connectionDevnet, payer } from "../config";

export const contractAddr = new PublicKey(idl.metadata.address)
export const stateAccount = loadKeypairFromFile("../../../.keys/programAccounts/stateAccount.json")
export const stakeList = loadKeypairFromFile("../../../.keys/programAccounts/stakeList.json")
export const validatorsList = loadKeypairFromFile("../../../.keys/programAccounts/validatorList.json")
export const operationalSolAccount = loadKeypairFromFile("../../../.keys/programAccounts/operationalSolAccount.json")
export const ssolMintKeypair = loadKeypairFromFile("../../../.keys/programAccounts/ssolMint.json")
export const lpMintKeypair = loadKeypairFromFile("../../../.keys/programAccounts/lpMint.json")
...
preRequisiteSetup(connectionDevnet, payer)