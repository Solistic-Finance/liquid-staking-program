...
pub struct Claim<'info> {
    ...
    #[account(
        mut,
        address = ticket_account.beneficiary @ SolisticError::WrongBeneficiary
    )]
...
impl<'info> Claim<'info> {
    ...
    fn check_ticket_account(&self) -> Result<()> {
        require_keys_eq!(
            ...
            self.state.key(),
            SolisticError::InvalidDelayedUnstakeTicket
        );
        ...
        require_neq!(
            ...
            0,
            SolisticError::ReusingDelayedUnstakeTicket
        );
    ...
    pub fn process(&mut self) -> Result<()> {
        ...
        if lamports > available_for_claim {
            ...
            return err!(SolisticError::TicketNotReady);
        }
