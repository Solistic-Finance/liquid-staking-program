use crate::{error::SolisticError, require_lte};
...
impl Fee {
    ...
    pub fn check(&self) -> Result<()> {
        require_lte!(
            ...
            SolisticError::BasisPointsOverflow
        );
        Ok(())
    }
...
impl TryFrom<f64> for Fee {
    ...
    fn try_from(n: f64) -> Result<Self> {
        ...
        let basis_points =
            u32::try_from(basis_points_i).map_err(|_| SolisticError::CalculationFailure)?;
...
impl FromStr for Fee {
    ...
    fn from_str(s: &str) -> Result<Self> {
        f64::try_into(s.parse().map_err(|_| SolisticError::CalculationFailure)?)
    }
}
...
impl FeeCents {
    ...
    pub fn check(&self) -> Result<()> {
        require_lte!(
            self,
            &Self::MAX_BP_CENTS,
            SolisticError::BasisPointCentsOverflow
        );
        Ok(())
    }
...
impl TryFrom<f64> for FeeCents {
    ...
    fn try_from(n: f64) -> Result<Self> {
        ...
        let bp_cents = u32::try_from(bp_cents_i).map_err(|_| SolisticError::CalculationFailure)?;
