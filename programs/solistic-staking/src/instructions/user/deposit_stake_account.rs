...
impl<'info> DepositStakeAccount<'info> {
    ...
    pub fn process(&mut self, validator_index: u32) -> Result<()> {
        ...
        require_gte!(
            ...
            SolisticError::DepositingNotActivatedStake
        );
        ...
        require_gte!(
            ...
            SolisticError::TooLowDelegationInDepositingStake
        );
        ...
        require_eq!(
            ...
            SolisticError::WrongStakeBalance,
        );
        ...
        if lockup.is_in_force(&self.clock, None) {
            ...
            return err!(SolisticError::StakeAccountWithLockup)
...

        {
            ...
            // Can not deposit stake already under solistic stake auth. old staker must be different than ours
            require_keys_neq!(
                old_staker,
                new_staker,
                SolisticError::RedepositingSolisticStake
            );
        ...
        let old_withdrawer = self.stake_account.meta().unwrap().authorized.withdrawer;
        {
            ...
            .unwrap();
            // Can not deposit stake already under solistic stake auth. old_withdrawer must be different than ours
            require_keys_neq!(
                old_withdrawer,
                new_withdrawer,
                SolisticError::RedepositingSolisticStake
        ...
        let ssol_to_mint = self.state.calc_ssol_from_lamports(delegation.stake)?;
        ...
        self.state.on_ssol_mint(ssol_to_mint);
