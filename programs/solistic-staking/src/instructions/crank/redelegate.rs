...
impl<'info> ReDelegate<'info> {
    ...
    pub fn process(
        ...
        require_neq!(
            ...
            SolisticError::SourceAndDestValidatorsAreTheSame
        );
        ...
        // only allow redelegation in the stake/unstake window at the end of the epoch
        {
            ...
            //     SolisticError::TooEarlyForStakeDelta
            // );
        }
        ...
        // add new warming-up re-delegated account to Solistic stake-accounts list
    ...
    pub fn split_stake_for_redelegation(
        ...
        // add the split account as new account to Solistic stake-accounts list
        self.state.stake_system.add(
            &mut self.stake_list.to_account_info().data.as_ref().borrow_mut(),
            &self.split_stake_account.key(),
