...
use crate::{calc::proportional, error::SolisticError, ID};
    ...
    pub fn new(
        ...
        require_keys_eq!(
            ...
            *duplication_flag_address,
            SolisticError::WrongValidatorDuplicationFlag
        );
...
impl AccountDeserialize for ValidatorList {
    ...
    fn try_deserialize(buf: &mut &[u8]) -> Result<Self> {
        if buf.len() < 8 {
            return err!(SolisticError::InvalidValidatorListDiscriminator);
        }
...
impl ValidatorSystem {
    ...
    pub fn remove(
        ...
        require_eq!(
            ...
            0,
            SolisticError::RemovingValidatorWithBalance
        );
